...
// --- appended: small concurrency limiter (createLimiter) ---
// Usage: const { createLimiter, sleep } = require('./utils');
// const limit = createLimiter(4);
// await limit(async () => { /* work */ });
...
// Export everything (existing exports preserved, plus createLimiter)
module.exports = {
  retryWithBackoff,
  sleep,
  quantizePrice,
