// src/index.js
// Runner with robust BybitWS instantiation + diagnostics to avoid "BybitWS is not a constructor" crashes.
...
console.log('Startup diag: FILTER_MTF=', process.env.FILTER_MTF || '(unset)', 'DEBUG_FILTERS=', process.env.DEBUG_FILTERS || cfg.DEBUG_FILTERS);
